...
public class Atlas_notes {
	...
	public void ClickNotes() {
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, 50);
			WebElement writeNotes = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//body[@id='tinymce']")));
		...
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, 50);
			WebElement save1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='Save']")));
			save1.click();
			System.out.println("--------------------------*****************-----------------------");
		...
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, 50);
			WebElement Cancel1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='Cancel']")));
			Cancel1.click();
			Thread.sleep(3000);
			System.out.println("--------------------------*****************-----------------------");
	...
	public void CheckNotes() {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 50);
			WebElement Note1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='/viewer/assets/images/colorsvg/comments.svg']")));
			Note1.click();
			Thread.sleep(3000);
			System.out.println("--------------------------*****************-----------------------");
			System.out.println("The Note icon is clicked");
		...
		try {
			driver.switchTo().frame(0);
			WebDriverWait wait = new WebDriverWait(driver, 50);
			WebElement removeNotes = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//body[@id='tinymce']")));
			removeNotes.clear()	;        
			Thread.sleep(3000);
			System.out.println("--------------------------*****************-----------------------");
		...
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, 50);
			WebElement Cancel = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='Cancel']")));
			Cancel.click();
			Thread.sleep(3000);
			System.out.println("--------------------------*****************-----------------------");
			System.out.println("The cancel button is clicked");
