	...
	public void table() throws InterruptedException {
		...
		try {
			...
			WebElement table2 = wait7.until(ExpectedConditions.elementToBeClickable(By.xpath(
					"/html/body/ngx-app/ngx-annotation/nb-layout/div/div/div/div/div/nb-layout-column/ngx-series-set-comp/div/ngx-explore-comp/nb-layout/div[1]/div/div/div/div/nb-layout-column[2]/nb-card/nb-card-body/div[1]/div/nb-card/nb-card-footer/nb-icon[1]/img")));
			table2.click();
			System.out.println("-------------------------------------------------");
			System.out.println("The viewer icon is clicked");
		} catch (Exception e) {
