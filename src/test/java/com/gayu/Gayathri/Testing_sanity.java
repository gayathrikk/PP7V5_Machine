...
public class Testing_sanity {
    ...
    public void login() throws InterruptedException {
        driver.get("http://dev2mani.humanbrain.in:70/annotation/portal");
    ...
    // Define the checkConsoleLog method
    ...
    // Placeholder for the Loginpage_API method
    private void Loginpage_API() {
        // Implementation for the API validation if needed
    }
