...
public class pp1_Machine {
    ...
    public void testStorageDetails() {
        ...
        try {
            ...
            ((ChannelExec) channel).setCommand("df -h /store/nvmestorage /store/repos2 /store/repos1/iitlab/humanbrain/analytics");
            ...
            for (int i = 1; i < lines.length; i++) {
                ...
                System.out.printf("| %-34s | %4s | %5s | %5s | %6s | %-47s |\n", parts[0], parts[1], parts[2], parts[3], parts[4], parts[5]);
                System.out.println("+------------------------------------+------+-------+-------+--------+-------------------------------------------------+");
    ...
    private void sendEmailAlert(String messageBody) {
        ...
        try {
            ...
            message.setSubject("PP1 Machine Storage Alert");
